...
echo "(./bin/${BINARY} -warmup_instructions ${N_WARM}000000 -simulation_instructions ${N_SIM}000000  -threads ${THREADS} ${OPTION}  -traces ${TRACE_DIR}/${TRACE}) &> results_${N_SIM}M_new/${TRACE}-${BINARY}${OPTION}.txt "
(./bin/${BINARY} -warmup_instructions ${N_WARM}000000 -simulation_instructions ${N_SIM}000000  -threads ${THREADS} ${OPTION}  -traces ${TRACE_DIR}/${TRACE}) &> results_${N_SIM}M_new/${TRACE}-${BINARY}${OPTION}.txt
