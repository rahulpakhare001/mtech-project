...
#define FILL_THRESHOLD 25 //EDIT MADE BY Neelu, changed from 90 to 25 to increase aggressiveness.
#define PF_THRESHOLD 15	//EDIT MADE BY Neelu, changed from 25 to 15 to increase aggressiveness.
...
class SIGNATURE_TABLE {
  public:
    ...
    void read_and_update_sig(uint64_t page, uint32_t page_offset, uint32_t &last_sig, uint32_t &curr_sig, int32_t &delta, uint8_t type);
};
