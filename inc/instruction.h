...
#define ROB_SIZE 352
#define LQ_SIZE 128
#define SQ_SIZE 500	/////144 ////72
#define NUM_INSTR_DESTINATIONS_SPARC 4
#define NUM_INSTR_DESTINATIONS 2
#define NUM_INSTR_SOURCES 4

// special registers that help us identify branches
#define REG_STACK_POINTER 6	//102 - qualcomm
#define REG_FLAGS 25	//64
#define REG_INSTRUCTION_POINTER 26	//103
...
class ooo_model_instr {
  public:
    uint64_t instr_id,
	     ...
	     dtlb_stall_end_cycle; //@Vasudha: Adding to count number of stall cycles die to DTLB	
    ...
    uint16_t destination_registers[NUM_INSTR_DESTINATIONS_SPARC]; // output registers

    uint16_t source_registers[NUM_INSTR_SOURCES]; // input registers 
	...
	load_stall_flag = 0;
	stall_flag = 0;
	dtlb_stall_end_cycle = 0;
	dtlb_end_stall_flag = 0;
