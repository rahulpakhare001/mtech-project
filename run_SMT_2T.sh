...
(./bin/${BINARY} -warmup_instructions ${N_WARM}000000 -simulation_instructions ${N_SIM}000000   -threads 2 ${OPTION}  -traces   ${TRACE_DIR}/${THREAD_0} ${TRACE_DIR}/${THREAD_1}  )  &> results_2core_${N_SIM}M/${THREAD_0}-${THREAD_1}-${BINARY}.txt
